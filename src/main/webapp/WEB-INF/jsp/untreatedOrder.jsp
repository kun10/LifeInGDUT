	...
	<div class="water-main" id="show-main">
			...
			<ul class="first-menu">
				<li><a href="#" class="first-menu-li">全部订单</a>
					<ul class="second-menu">
						<li class="chooseBgColor"><a href="/LifeInGDUT/water/getOrder?state=-1&page=1">未接订单</a></li>
		...
		<div class="water-data">
			...
			<div class="water-data-pages">
				<div class="selectBox">
					选择配送员:
					<select id="selectChoose" name="deliver" form="accept">
						<option value="A">配送员A</option>
						<option value="B">配送员B</option>
						<option value="C">配送员C</option>
						<option value="D">配送员D</option>
					</select>
					<span class="acceptOrder">确认接单</span>
				</div>
				<div id="setpage"></div> 
			</div>
			<!--订单详情-->
